<h1 align="center"><a href="https://thefriendly.coach/courses/build-an-app-with-the-aws-cloud-development-kit?af=6p5abz">Build an App with the AWS Cloud Development Kit</a></h1>
...
This repo contains notes from [Toni Haupt](https://twitter.com/thefriendlycoach)'s thefriendly.coach course [Build an App with the AWS Cloud Development Kit](https://thefriendly.coach/courses/build-an-app-with-the-aws-cloud-development-kit?af=6p5abz).
...
| ------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| [📹 Collection](https://thefriendly.coach/playlists/learn-aws-lambda-from-scratch-d29d?af=6p5abz) | [📹 Collection](https://thefriendly.coach/playlists/learn-aws-serverless-application-model-aws-sam-framework-from-scratch-baf9?af=6p5abz) | [📹 Collection](https://thefriendly.coach/playlists/learn-aws-dynamodb-from-scratch-21c3?af=6p5abz) | [📹 Collection](https://thefriendly.coach/playlists/learn-aws-dynamodb-from-scratch-21c3?af=6p5abz)   |
| [🤔 Notes](https://github.com/theianjones/thefriendly.coach_learn_aws_lambda_from_scratch)        | [🤔 Notes](https://github.com/tfc-projects/build-serverless-applications-with-aws-sam)                                                    | [🤔 Notes](https://github.com/tfc-projects/learn-aws-dynamodb-from-scratch)                         | [🤔 Notes](https://github.com/tfc-projects/intro-to-dynamodb)                                         |

## Who is Toni Haupt? 👨‍💻

Lead UI consultant at codecentric AG. His interests include React, AWS, testing, AR, app performance and... jQuery (a rudiment from the past 🤟), which he still thinks is the best library ever.

[Other friendly coach content](https://thefriendly.coach/instructors/toni-haupt) created by Toni.
